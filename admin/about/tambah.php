          ...
          <form action="proses_simpan.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                <label>Judul</label>
                <input type="text" name="judul_post" class="form-control" placeholder="Masukan Judul" required>
              </div>
              <div class="form-group">
                <label>Isi</label>
                <input type="text" name="isi_post" class="form-control" placeholder="Masukan Deskripsi" required>
              </div>
            </div>
            <!-- /.card-body -->
