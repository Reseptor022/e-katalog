          ...
          <form action="proses_edit.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="judul_post" class="form-control" placeholder="Masukan Judul" value="<?= $judul ?>" required>
              </div>
              <input type="hidden" name="id" value="<?= $id ?>">
              <div class="form-group">
                <label>Isi</label>
                <input type="text" name="isi_post" class="form-control" placeholder="Masukan Deskripsi" value="<?= $isi ?>" required>
              </div>
            </div>
        </div>
        <!-- /.card-body -->
